    ...
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-t border-neutral-200 shadow-lg px-2 py-1.5 flex items-center justify-around">
            ...
            >
              <div className="relative">
                ...
                {item.id === "requests" && notificationCount > 0 && (
                  <span className="absolute -top-1 -right-1.5 bg-neutral-900 text-white text-[9px] w-4 h-4 rounded-full flex items-center justify-center font-bold">
                    {notificationCount}
                  </span>
                )}
              </div>
        ...
        <button
          ...
          className="flex flex-col items-center justify-center w-14 py-1 text-neutral-500 hover:text-neutral-800"
        >
        ...
        <button
          ...
          className="flex flex-col items-center justify-center w-14 py-1 text-red-600 font-bold"
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 text-red-600 font-bold">SOS</span>
        </button>
      </nav>
    </>
  );
