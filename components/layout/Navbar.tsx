    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-neutral-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 border-b border-neutral-100">
        <div className="flex items-center justify-between gap-3 text-xs text-neutral-600">
          {/* -------------------------------------------------
              RESIDENTIAL COMMUNITY SWITCHER
          -------------------------------------------------- */}
          <div className="relative shrink-0">
            <button
              ...
              className="flex items-center gap-2 font-medium text-neutral-900 hover:text-neutral-700 bg-neutral-100 hover:bg-neutral-200 px-3 py-1.5 rounded-lg transition-colors border border-neutral-200"
            >
              ...
              <span className="hidden sm:inline bg-neutral-200 text-neutral-800 text-[10px] font-semibold px-1.5 py-0.5 rounded">
                {society.city}
              </span>
          ...
          {/* -------------------------------------------------
              ROLE / ASSISTANT / EMERGENCY
          -------------------------------------------------- */}
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            {/* Resident Role Selector */}
            <div className="relative flex items-center bg-neutral-100 hover:bg-neutral-200/80 px-2.5 py-1.5 rounded-lg border border-neutral-200/90 transition-colors">
              <label
                htmlFor="user-role"
                className="sr-only"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            aria-label={`Open requests${requestCount > 0
                ? `, ${requestCount} active`
                : ""
              }`}
          >
