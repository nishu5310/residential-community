  ...
  return (
    <main className="min-h-screen bg-neutral-50/50 py-10 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-neutral-900 font-sans selection:bg-neutral-900 selection:text-white">
      ...
      <div className="saas-card p-6 sm:p-8 space-y-6 text-xs leading-relaxed text-neutral-700">
        ...
        <section className="space-y-2 pt-4 border-t border-neutral-100">
          <h2 className="text-sm font-bold text-neutral-900">
            4. Home Services & Provider Verification
          </h2>
          <p>
            Service providers listed in the marketplace operate as independent professionals or partner agencies. Service providers may be subject to identity or background verification where applicable, as indicated on their verified provider badge. Specific warranty or service terms are governed by the individual service agreement provided upon booking confirmation.
          </p>
        </section>
